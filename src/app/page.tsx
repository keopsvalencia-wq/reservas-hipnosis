  ...
  const renderScreen = () => {
    switch (screen) {
      ...
      case 3:
        return (
          <StepLayout fill>
            <div className="space-y-6 md:space-y-12 max-w-3xl mx-auto w-full pt-3">
      ...
      <div className="w-full max-w-lg flex items-start justify-between gap-4 px-2 md:px-4 mx-auto">
        ...
        <div className="flex flex-col items-center shrink-0 w-auto">
          <motion.button
            ...
            className={`btn-primary uppercase tracking-wider transition-all whitespace-nowrap ${nextDisabled
